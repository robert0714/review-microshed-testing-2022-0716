...
public class PersonResourceIT {
    ...
    public void shouldCreatePerson() {
        ...
        String createdUrl = result.getHeaderString("Location");
        assertNotNull(createdUrl);

        Long id = Long.valueOf(createdUrl.substring(createdUrl.lastIndexOf('/') + 1));
        assertTrue(id > 0, "Generated ID should be greater than 0 but was: " + id);
        
        Person newPerson = personsEndpoint.getPersonById(id);
